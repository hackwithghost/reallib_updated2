...
export const ListStudentsResponseItem = zod.object({
  ...
  "isPaid": zod.boolean(),
  "unpaidSince": zod.string().nullish(),
 ...
 */
export const ToggleStudentPaymentParams = zod.object({
  "id": zod.coerce.number()
})

export const ToggleStudentPaymentBody = zod.object({
  "isPaid": zod.boolean()
})

export const ToggleStudentPaymentResponse = zod.object({
  "id": zod.number(),
  "name": zod.string(),
  "rollNumber": zod.string(),
  "phoneNumber": zod.string(),
 ...
 */
export const GetUnpaidStudentsResponseItem = zod.object({
  "id": zod.number(),
  "name": zod.string(),
  "rollNumber": zod.string(),
  "phoneNumber": zod.string(),
  ...
  "isPaid": zod.boolean(),
  "unpaidSince": zod.string().nullish(),
  "daysUnpaid": zod.number(),
  "isOverdue": zod.boolean(),
  "createdAt": zod.string()
})
export const GetUnpaidStudentsResponse = zod.array(GetUnpaidStudentsResponseItem)


/**
 * @summary Get allocated students who did not mark attendance on a given date
 */
export const GetAbsentStudentsQueryParams = zod.object({
  "date": zod.coerce.string().optional().describe('Date in YYYY-MM-DD format (defaults to today)')
})

export const GetAbsentStudentsResponseItem = zod.object({
  "id": zod.number(),
  "name": zod.string(),
  "rollNumber": zod.string(),
  "phoneNumber": zod.string(),
  ...
  "allocatedSlot": zod.string().nullish(),
  "createdAt": zod.string()
})
export const GetAbsentStudentsResponse = zod.array(GetAbsentStudentsResponseItem)
